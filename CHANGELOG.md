...
## [1.48.0](https://github.com/otto-nation/otto-workbench/compare/v1.47.0...v1.48.0) (2026-08-19)
...
* **claude:** trust the node family; block four more prompt shapes ([#739](https://github.com/otto-nation/otto-workbench/issues/739)) ([982873d](https://github.com/otto-nation/otto-workbench/commit/982873d53695f78576510d986d4648cab8177251))
* **eval:** add a fixture harness for in-session skill execution ([#687](https://github.com/otto-nation/otto-workbench/issues/687)) ([eab0a63](https://github.com/otto-nation/otto-workbench/commit/eab0a635abb6822b61808dc6af37a418f4216fbd))
...
* **pr:** run the supersession preflight beyond pr comments ([#768](https://github.com/otto-nation/otto-workbench/issues/768)) ([3273805](https://github.com/otto-nation/otto-workbench/commit/3273805cc247656f76f4863aac03154f74bdb077))
...
* **review:** retry phases that produce no output; write-aware steer ([#594](https://github.com/otto-nation/otto-workbench/issues/594)) ([fc30459](https://github.com/otto-nation/otto-workbench/commit/fc304592a6427df5dd4405628f3f958c25612568))
* **site:** publish the docs to GitHub Pages with fumadocs ([#767](https://github.com/otto-nation/otto-workbench/issues/767)) ([f0f90d4](https://github.com/otto-nation/otto-workbench/commit/f0f90d44b227736111634354f1a91f0382e9d24f))
...
* **validate:** fail CI when a --tool-schema claim goes unanswered ([#800](https://github.com/otto-nation/otto-workbench/issues/800)) ([e406a47](https://github.com/otto-nation/otto-workbench/commit/e406a47874681734ac7f11eeb8111e6ad385e78c))
* **workbench:** unified config.yml with a generated JSON schema ([#726](https://github.com/otto-nation/otto-workbench/issues/726)) ([5aad0dc](https://github.com/otto-nation/otto-workbench/commit/5aad0dcc75052c2001e1f807daa807511bf61953))


### Bug Fixes

* **ai:** block env -C; cite rules sections in guard messages ([#688](https://github.com/otto-nation/otto-workbench/issues/688)) ([1271567](https://github.com/otto-nation/otto-workbench/commit/127156759431e21c7752ccc78c4b5e93e17996bd))
* **ai:** harden the session mtime stat chain; add coverage ([#629](https://github.com/otto-nation/otto-workbench/issues/629)) ([bcec837](https://github.com/otto-nation/otto-workbench/commit/bcec837ec337d7abacf7d77b6e67d7f124c386ec))
...
* **anatomy:** drop per-file forks; index directories past the cap ([#722](https://github.com/otto-nation/otto-workbench/issues/722)) ([364158c](https://github.com/otto-nation/otto-workbench/commit/364158c062b9392114dd03234545f186cb878ad1))
* **bash-tool:** steer background processes to run_in_background ([#792](https://github.com/otto-nation/otto-workbench/issues/792)) ([68ede76](https://github.com/otto-nation/otto-workbench/commit/68ede7624583dac71e940d3b6d73055fb09d33f9))
* **ceiling-scan:** skip binaries and gate the quadratic regex ([#716](https://github.com/otto-nation/otto-workbench/issues/716)) ([a774fa2](https://github.com/otto-nation/otto-workbench/commit/a774fa2f12e6f89b147682e6786ba12e1e43f11d))
* **ceiling:** read the trigger the marker already names ([#772](https://github.com/otto-nation/otto-workbench/issues/772)) ([5333326](https://github.com/otto-nation/otto-workbench/commit/53333267ef92177b6163ffdd598e01a85eba4f07))
* **claude:** block absolute paths to /bin and /usr/bin binaries ([#689](https://github.com/otto-nation/otto-workbench/issues/689)) ([ab1ac8e](https://github.com/otto-nation/otto-workbench/commit/ab1ac8e8646dae69b48be098271e88cc16ea76f8))
...
* **docker:** detect COLIMA_ARCH from uname instead of pinning x86_64 ([#683](https://github.com/otto-nation/otto-workbench/issues/683)) ([ba1dfdb](https://github.com/otto-nation/otto-workbench/commit/ba1dfdb49ad2a63ddeadacfed4856428ee9add4e))
* **git:** reject placeholder commit identities; guard test config writes ([#598](https://github.com/otto-nation/otto-workbench/issues/598)) ([1a976fd](https://github.com/otto-nation/otto-workbench/commit/1a976fde770aba221a2a663b51e00b8599d308d5))
* **lock:** scope the run lock and PR state to the run's target ([#692](https://github.com/otto-nation/otto-workbench/issues/692)) ([aa38d93](https://github.com/otto-nation/otto-workbench/commit/aa38d93708e0a562891f8e2806ddddc36414e246))
* **mcp:** derive tool discovery dirs from the component layout ([#760](https://github.com/otto-nation/otto-workbench/issues/760)) ([fc94cbf](https://github.com/otto-nation/otto-workbench/commit/fc94cbff1fd4f048387c7b54facab149b37e6973))
...
* **migrations:** give adoption-sensitive migrations another pass ([#756](https://github.com/otto-nation/otto-workbench/issues/756)) ([e447bd6](https://github.com/otto-nation/otto-workbench/commit/e447bd6a0f0582e19cf2357e52d1ae9483c182d8))
* **migrations:** isolate migration failures from the sync run ([#750](https://github.com/otto-nation/otto-workbench/issues/750)) ([f9f7035](https://github.com/otto-nation/otto-workbench/commit/f9f70357429b305cba37d4e3dea91e8c44fc3dcf))
* **nesting:** carry quote state across lines in the bash checker ([#729](https://github.com/otto-nation/otto-workbench/issues/729)) ([a8d5903](https://github.com/otto-nation/otto-workbench/commit/a8d590349f430c8c1bb5941c40801dace0ac2b74))
* **permissions:** revive four rules that could never match ([#785](https://github.com/otto-nation/otto-workbench/issues/785)) ([9ce72f2](https://github.com/otto-nation/otto-workbench/commit/9ce72f2684e0272eb373d0153045cbb1ad38a48c))
...
* **pr-comments:** hold the push while a thread is contested ([#718](https://github.com/otto-nation/otto-workbench/issues/718)) ([804da09](https://github.com/otto-nation/otto-workbench/commit/804da095137c140c0e24de7fad1a3e3fed181b54))
* **pr-comments:** keep the summary comment complete across rounds ([#727](https://github.com/otto-nation/otto-workbench/issues/727)) ([c42a3b9](https://github.com/otto-nation/otto-workbench/commit/c42a3b9ee7797be752dd4ba262d963c2565bae27))
...
* **pr-comments:** queue triage replies so --finish can drain a draft ([#781](https://github.com/otto-nation/otto-workbench/issues/781)) ([2626f54](https://github.com/otto-nation/otto-workbench/commit/2626f542cf14672ae5b8fbcb5804304ca55aa485))
* **pr-comments:** repost the summary once a reviewer answers it ([#773](https://github.com/otto-nation/otto-workbench/issues/773)) ([c81afae](https://github.com/otto-nation/otto-workbench/commit/c81afaef652a4098cd84c4b0555be4da8d564ac1))
...
* **pr-context:** surface command stderr instead of asserting a cause ([#748](https://github.com/otto-nation/otto-workbench/issues/748)) ([f7aae5e](https://github.com/otto-nation/otto-workbench/commit/f7aae5e18fe0721d9a6f8510ea9d0a9135cc08de))
...
* **pr-rebase:** commit the hook-validated tree and protect stashed work ([#666](https://github.com/otto-nation/otto-workbench/issues/666)) ([0bd7e8c](https://github.com/otto-nation/otto-workbench/commit/0bd7e8cb92d0e555aecc1bf7fecb5e9924554f5f))
...
* **pr-rebase:** refuse to rebase branches whose work already landed ([#747](https://github.com/otto-nation/otto-workbench/issues/747)) ([c2df967](https://github.com/otto-nation/otto-workbench/commit/c2df9675c848f49f5dd6ecd580343ed4e7c16e2d))
...
* **pr-rebase:** stop checkout -B discarding unpushed commits ([#755](https://github.com/otto-nation/otto-workbench/issues/755)) ([ce33a97](https://github.com/otto-nation/otto-workbench/commit/ce33a979647e8954363b758e5d3e158ab4cc08f7))
...
* **pr-review:** restore scout cache prefix optimization ([#586](https://github.com/otto-nation/otto-workbench/issues/586)) ([718fc81](https://github.com/otto-nation/otto-workbench/commit/718fc816d5c31dec5f3795b846b9a34cb56cc3bd))
* **pr-state:** let load_state survive a corrupt state file ([#673](https://github.com/otto-nation/otto-workbench/issues/673)) ([61f720b](https://github.com/otto-nation/otto-workbench/commit/61f720b182371e0500efb0fa3c86c79ddb38763a))
...
* **pr:** count the fix replies `--finish` drains ([#723](https://github.com/otto-nation/otto-workbench/issues/723)) ([e0a82c2](https://github.com/otto-nation/otto-workbench/commit/e0a82c23d588402c67e7da1b5b13abdafbd02c57))
...
* **pr:** honor draft mode and edit replies on resolved threads ([#701](https://github.com/otto-nation/otto-workbench/issues/701)) ([ea54f5e](https://github.com/otto-nation/otto-workbench/commit/ea54f5e3a02595ffd01d0a67c20642b77c74c189))
* **pr:** resolve delegate flag arity before picking a target ([#700](https://github.com/otto-nation/otto-workbench/issues/700)) ([4e66cd2](https://github.com/otto-nation/otto-workbench/commit/4e66cd2bd6dd2fa92192bce948c7fb92e47782b5))
* **pr:** serialize concurrent runs on a worktree ([#659](https://github.com/otto-nation/otto-workbench/issues/659)) ([a697a72](https://github.com/otto-nation/otto-workbench/commit/a697a72737c27d163d9f19e86ad79a42f328c06d))
* **pr:** stop pr create from swallowing its flag values ([#745](https://github.com/otto-nation/otto-workbench/issues/745)) ([5dea040](https://github.com/otto-nation/otto-workbench/commit/5dea04041c38f598d6d03e0f0e0831f7dca6a73f))
...
* **pr:** surface the undelivered closeout in pr status ([#787](https://github.com/otto-nation/otto-workbench/issues/787)) ([024b468](https://github.com/otto-nation/otto-workbench/commit/024b468418eef502ffa4efacdde7815ffa284e06))
* **pr:** trust gh's exit code when creating a PR ([#698](https://github.com/otto-nation/otto-workbench/issues/698)) ([6c43f71](https://github.com/otto-nation/otto-workbench/commit/6c43f71398bf0091732e2896def86058e1192fc9))
...
* **review-github:** carry stderr so gh failures name a cause ([#757](https://github.com/otto-nation/otto-workbench/issues/757)) ([4a33027](https://github.com/otto-nation/otto-workbench/commit/4a33027c5df8ece177606bb59c944cef0ce2eb45))
* **review-threads:** render needs_human actions as prose ([#788](https://github.com/otto-nation/otto-workbench/issues/788)) ([4fa89c2](https://github.com/otto-nation/otto-workbench/commit/4fa89c203d66d4d4e69d3be73fcf11a12763f8c8))
* **review-threads:** settle comment items via their source ([#789](https://github.com/otto-nation/otto-workbench/issues/789)) ([3efc9c9](https://github.com/otto-nation/otto-workbench/commit/3efc9c98ab0681f6b3a643d6b2679db42060af9b))
* **review:** charge the running total for synthesis ([#669](https://github.com/otto-nation/otto-workbench/issues/669)) ([f4fe832](https://github.com/otto-nation/otto-workbench/commit/f4fe832965c5526ab81dc094d7c34d95e8220b8c))
* **review:** clean up disprove artifacts on the happy path ([#677](https://github.com/otto-nation/otto-workbench/issues/677)) ([a440f78](https://github.com/otto-nation/otto-workbench/commit/a440f789913c58c63c6ef692fc377e8374d1f0ee))
* **review:** correct commit attribution and hold side effects on contested premises ([#746](https://github.com/otto-nation/otto-workbench/issues/746)) ([250a01c](https://github.com/otto-nation/otto-workbench/commit/250a01c35fd82647913393274de1944fca6b85bd))
* **review:** keep cross-references pointing at the finding they name ([#725](https://github.com/otto-nation/otto-workbench/issues/725)) ([3cb4d06](https://github.com/otto-nation/otto-workbench/commit/3cb4d06bcfb38732c489c08b07651b940d0cea1a))
* **review:** let the effort preset own the multi-phase line threshold ([#644](https://github.com/otto-nation/otto-workbench/issues/644)) ([bda94a5](https://github.com/otto-nation/otto-workbench/commit/bda94a55897adff34fe365cc0a91031b5b4b3757))
* **review:** let the fix pass edit; retry a no-tool refusal ([#600](https://github.com/otto-nation/otto-workbench/issues/600)) ([233bee2](https://github.com/otto-nation/otto-workbench/commit/233bee2f8285bba2831ab99efe481b32049e8ed0))
* **review:** match Vertex quota on the family bucket, not just the version ([#602](https://github.com/otto-nation/otto-workbench/issues/602)) ([cc45081](https://github.com/otto-nation/otto-workbench/commit/cc45081bb7a226149f9c64b10159f3c03ee76994))
* **review:** normalize both sides of the evidence match ([#704](https://github.com/otto-nation/otto-workbench/issues/704)) ([c146761](https://github.com/otto-nation/otto-workbench/commit/c146761a1a6b2339cf5275aea5705ef15c7d6dbc))
...
* **review:** parse finding paths holding spaces and non-ASCII ([#791](https://github.com/otto-nation/otto-workbench/issues/791)) ([3b7d312](https://github.com/otto-nation/otto-workbench/commit/3b7d312f4ac4340c7fa963c53c9f6271ce2c83c3))
* **review:** patch every binding of a name through the module proxy ([#649](https://github.com/otto-nation/otto-workbench/issues/649)) ([9300002](https://github.com/otto-nation/otto-workbench/commit/93000028254004ddee135183b261d5b4bbe45c15))
* **review:** reconcile prior findings through a disposition ledger ([#696](https://github.com/otto-nation/otto-workbench/issues/696)) ([5ccba7e](https://github.com/otto-nation/otto-workbench/commit/5ccba7ecbbbb427d2bad4897fd3cb4db2f71e4de))
* **review:** reconcile review prose with dropped findings ([#709](https://github.com/otto-nation/otto-workbench/issues/709)) ([06e58f5](https://github.com/otto-nation/otto-workbench/commit/06e58f597e0b9966e4909a585f18488dbf8c1ed6))
...
* **review:** report a pre-push gate failure as a failed gate ([#635](https://github.com/otto-nation/otto-workbench/issues/635)) ([8bb1181](https://github.com/otto-nation/otto-workbench/commit/8bb11818c90749f25eb3a073a48241b6c5b55a53))
* **review:** report incremental skips as skipped, not agent failures ([#695](https://github.com/otto-nation/otto-workbench/issues/695)) ([7e04004](https://github.com/otto-nation/otto-workbench/commit/7e040040273b335a80f2181428abe60587cf79b5))
* **review:** review local HEAD in self mode, not the PR head ([#607](https://github.com/otto-nation/otto-workbench/issues/607)) ([f7d253b](https://github.com/otto-nation/otto-workbench/commit/f7d253bfcfc73573df528d63a8ffa849ac5f40a2))
* **review:** scope fix-pass commits; honor declined findings ([#790](https://github.com/otto-nation/otto-workbench/issues/790)) ([1aff741](https://github.com/otto-nation/otto-workbench/commit/1aff7411025d151d25f7ff02d3d3d9019713421f))
...
* **review:** sum a resumed run's spend from the logs on disk ([#668](https://github.com/otto-nation/otto-workbench/issues/668)) ([bfe92e6](https://github.com/otto-nation/otto-workbench/commit/bfe92e654d0f3abe21d97711c1c2ae6d06137c9a))
...
* **review:** sweep intermediates after the fix pass ([#699](https://github.com/otto-nation/otto-workbench/issues/699)) ([38fcbf4](https://github.com/otto-nation/otto-workbench/commit/38fcbf407ec52c59193dded9050c92b2f5941f0d))
* **roots:** align the state root description across both libs ([#737](https://github.com/otto-nation/otto-workbench/issues/737)) ([0936a76](https://github.com/otto-nation/otto-workbench/commit/0936a760ad47fa641d4bb22e44c2f26624c69bf7))
* **rules:** put --repo after the gh subcommand ([#783](https://github.com/otto-nation/otto-workbench/issues/783)) ([5f2cd21](https://github.com/otto-nation/otto-workbench/commit/5f2cd2166e826bf2ddb4b66bf1aa34809f4f90cf))
* **tests:** stop blaming tests for worktrunk's writes to shared config ([#632](https://github.com/otto-nation/otto-workbench/issues/632)) ([f805e57](https://github.com/otto-nation/otto-workbench/commit/f805e57e108216e1295fba5551a455a042dfe260))
* **tests:** stop worktrunk's branch history failing a random test ([#779](https://github.com/otto-nation/otto-workbench/issues/779)) ([77c5e55](https://github.com/otto-nation/otto-workbench/commit/77c5e55a5cb7a4ce91b22c2d6d77abfa690efd18))
* **zsh:** keep values set inside the .env.local ENV block ([#786](https://github.com/otto-nation/otto-workbench/issues/786)) ([35f4590](https://github.com/otto-nation/otto-workbench/commit/35f4590eb66c6abb95b8db3906e3451d4c1177d6))


### Dependencies

* update site packages and pinned github actions ([#777](https://github.com/otto-nation/otto-workbench/issues/777)) ([d4cc7a1](https://github.com/otto-nation/otto-workbench/commit/d4cc7a1ca01f1d351f409fa4636938967b15556e))
...
* **ai:** stop generating permissions into settings.json ([#799](https://github.com/otto-nation/otto-workbench/issues/799)) ([6752fb2](https://github.com/otto-nation/otto-workbench/commit/6752fb291f3eef0696a066b7a2162912d8859026))
* **claude:** extract the Bash PreToolUse guard into a script ([#691](https://github.com/otto-nation/otto-workbench/issues/691)) ([2c5de6e](https://github.com/otto-nation/otto-workbench/commit/2c5de6e7b45fb7ddf1a435498b3c011f886e5bfa))
* **lib:** add portable stat helpers; gate direct stat calls ([#634](https://github.com/otto-nation/otto-workbench/issues/634)) ([ccda7ad](https://github.com/otto-nation/otto-workbench/commit/ccda7ad105a6a278133d00843cbf3c57b126a451))
* **otto-log:** make the stats row and column named types ([#778](https://github.com/otto-nation/otto-workbench/issues/778)) ([13945d5](https://github.com/otto-nation/otto-workbench/commit/13945d53f7d9bf39c2d80f447ae27fb89ea047f8))
* **pr-state:** let serde and each domain own the schema ([#664](https://github.com/otto-nation/otto-workbench/issues/664)) ([ddc171c](https://github.com/otto-nation/otto-workbench/commit/ddc171c2962a7f47b119459f18851c693519dda3))
* **pr:** declare dispatch needs per command ([#802](https://github.com/otto-nation/otto-workbench/issues/802)) ([29f4666](https://github.com/otto-nation/otto-workbench/commit/29f4666e7e54f91f015081bdf543e4b5849b0b3b))
* **pr:** drop the deprecated --resolve aliases for --finish ([#758](https://github.com/otto-nation/otto-workbench/issues/758)) ([39c4501](https://github.com/otto-nation/otto-workbench/commit/39c45014bfdf35f4abb8108c944efc7aa3590f34))
...
* **pr:** keep per-worktree state in the worktree's git dir ([#681](https://github.com/otto-nation/otto-workbench/issues/681)) ([0dda808](https://github.com/otto-nation/otto-workbench/commit/0dda8085f6d31e29e48800ae72921c2cb70e62f2))
* **review:** clean up review_phases' inherited patterns ([#653](https://github.com/otto-nation/otto-workbench/issues/653)) ([d9aea32](https://github.com/otto-nation/otto-workbench/commit/d9aea323f9a313e394c9ac0a1d11905f76d1c6cf))
...
* **review:** derive a phase's output artifact from the phase ([#674](https://github.com/otto-nation/otto-workbench/issues/674)) ([4ca345c](https://github.com/otto-nation/otto-workbench/commit/4ca345c34ab51ec30e1b4387dc78f980737eb47a))
* **review:** derive a phase's session log from the phase ([#660](https://github.com/otto-nation/otto-workbench/issues/660)) ([a09bbe4](https://github.com/otto-nation/otto-workbench/commit/a09bbe45736c62e997fa9e34a66170014dc2b98e))
* **review:** let PhaseSpec own the omitted-file turn bump ([#658](https://github.com/otto-nation/otto-workbench/issues/658)) ([e7af38e](https://github.com/otto-nation/otto-workbench/commit/e7af38e9b6f23d59d73ef820c225571b14a5ebb4))
* **review:** let PipelineState own the pipeline-state schema ([#651](https://github.com/otto-nation/otto-workbench/issues/651)) ([a55fad5](https://github.com/otto-nation/otto-workbench/commit/a55fad52c25a32ca2d51ec904bcb652e2600e598))
* **review:** resolve the reviews root per call ([#717](https://github.com/otto-nation/otto-workbench/issues/717)) ([4b6f405](https://github.com/otto-nation/otto-workbench/commit/4b6f4059f8198e96c20bb2032041f2df2b4a1e81))
* **review:** split review_pipeline along the typed seams ([#647](https://github.com/otto-nation/otto-workbench/issues/647)) ([2b07c8f](https://github.com/otto-nation/otto-workbench/commit/2b07c8f0318acb51d1510babfdcb814996101ca9))
* **review:** type synthesis failures and the review-type vocabulary ([#652](https://github.com/otto-nation/otto-workbench/issues/652)) ([b2cd3fc](https://github.com/otto-nation/otto-workbench/commit/b2cd3fcf3d5c1f22855f706f04d28e34e89925c3))
...
* **review:** walk the reviews tree once, from meta.json ([#801](https://github.com/otto-nation/otto-workbench/issues/801)) ([c0b7f8e](https://github.com/otto-nation/otto-workbench/commit/c0b7f8efb1b268ac91ea249b5d5745b6e27a42ae))
* **serde:** give the state files one atomic write ([#715](https://github.com/otto-nation/otto-workbench/issues/715)) ([4f557cc](https://github.com/otto-nation/otto-workbench/commit/4f557ccf30b203758ae964418236f537e83925c3))
* **serde:** share one hint walk with schema_gen ([#720](https://github.com/otto-nation/otto-workbench/issues/720)) ([fda7c63](https://github.com/otto-nation/otto-workbench/commit/fda7c63adf8850598ce4593016bc9939f9844a64))
* **trail:** unify the trail root; add a terminal summary event ([#730](https://github.com/otto-nation/otto-workbench/issues/730)) ([ce7850e](https://github.com/otto-nation/otto-workbench/commit/ce7850ee627c20036c8b21c664c98946f953c995))
* **vertex:** cache quota lookups under the workbench cache root ([#679](https://github.com/otto-nation/otto-workbench/issues/679)) ([32fb216](https://github.com/otto-nation/otto-workbench/commit/32fb21698bfc2c08883cda2ec235286adab88791))
* **workbench:** resolve config, state, and cache roots in one place ([#650](https://github.com/otto-nation/otto-workbench/issues/650)) ([b30c8e4](https://github.com/otto-nation/otto-workbench/commit/b30c8e4bfbe6913349415d6ef9d5ea59302bf396))
* **workbench:** split the config and state roots ([#682](https://github.com/otto-nation/otto-workbench/issues/682)) ([3b743a7](https://github.com/otto-nation/otto-workbench/commit/3b743a79e4084119099a9623358f95977d272e27))
