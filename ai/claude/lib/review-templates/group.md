...
## Turn budget
You have ${max_turns} tool calls. Write your findings file FIRST based on the pre-collected diff and file contents — do not investigate before writing. Use any remaining turns to verify specific concerns and update the file.
${prior_section}
