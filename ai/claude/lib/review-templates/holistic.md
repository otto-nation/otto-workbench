...
## Turn budget
You have ${max_turns} tool calls. Write your assessment file within the first few turns. For files listed under "Files not pre-collected," read only those critical to the holistic assessment.
