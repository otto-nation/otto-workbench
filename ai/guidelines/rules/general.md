...
- When adding or changing auto-triggered lifecycle behavior (hooks, cooldowns, pending flags), update the skill's SKILL.md frontmatter (`lifecycle_*` fields) and run `generate-tool-context`
