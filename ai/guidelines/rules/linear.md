...
- Always create the Linear issue before creating a branch — the branch naming convention requires the issue ID prefix, so the issue must exist first. Sequence: (1) create issue, (2) create branch with issue ID
