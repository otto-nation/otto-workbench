...
# `git worktree add` materializes every file, and `checkout` and `stash` write
# or restore as much of it as they touch, so the honest bound is a function of
# the repo, not a constant. And work that executes someone else's code —
